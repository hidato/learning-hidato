...
def find_ranges(data):
    result = []
    for _key, group in groupby(enumerate(data), lambda x: x[0] - x[1]):
...
def main():
    grid = [36, 0, 0, 0, 14, 0, 4, 3, 34, 10, 0, 0, 2, 0, 0, 0, 0, 0, 1, 0, 0, 0, 18, 0, 30, 0, 0, 7, 20, 0, 0, 29, 26,
            0, 23, 22]

    # grid = [31, 0, 0, 0, 11, 9, 0, 0, 0, 0, 0, 8, 27, 0, 33, 0, 0, 0, 0, 25, 36, 17, 0, 0, 0, 23, 0, 19, 4, 0, 0, 0, 0,
    #         0, 0, 1]
    grid = solve(6, 6, grid)
    display(6, 6, grid)
    print(grid)
